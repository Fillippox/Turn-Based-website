                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        ...
	                        <p class="hero-paragraph"> Are you ready for an exciting and challenging turn-based adventure? 
								Dive into the game and test your strategy skills as you battle your way to victory. 
								Don't wait any longer, try our early version and see if you have what it takes to come out on top!

							</p>
	                        <div class="hero-cta"><a class="button button-primary button-shadow" href="login_system/login_form.php">Early access</a></div>
						</div>
						<div class="hero-app">
							...
							<img class="device-mockup" src="dist/images/gameSS.png" alt="App preview">
            ...
            <section class="features section">
                <div class="container">
					<div class="features-inner section-inner has-bottom-divider">
						<h2 class="section-title mt-0">Available features</h2>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
									<div class="feature-icon">
										<img width="64" height="64" src="images/swords2.png"/>
									</div>
									<h3 class="feature-title mt-24">
										Turn base combat
									</h3>
									<p class="text-sm mb-0">
										Combat time is split into turns, during which individual units can act in a more or less fixed order.
										While a player contemplates their next action and time Stands Still for everyone on the battlefield.
									</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
									<div class="feature-icon">
										<img width="64" height="64" src="images/backpack.png"/>
									</div>
									<h3 class="feature-title mt-24">Collecting loot</h3>
									<p class="text-sm mb-0">
										Carry on an amazing yet often dangerous adventures and battles to collect Fbucks, items and new companions.
									</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img width="64" height="64" src="images/shopper.png"/>
                                    </div>
									<h3 class="feature-title mt-24">Shop</h3>
									<p class="text-sm mb-0">
										Place where you are able to purchase high quality items for a hefty part of your Fbucks, however low price necessaries for every adventurer are also available.
									</p>
                                </div>
                            </div>
            </section>
                ...
                <div class="container-sm">
                    <div class="media-inner section-inner">
                        <div class="media-header text-center">
                            <h2 class="section-title mt-0">Meet Momoa</h2>
                            <p class="section-paragraph mb-0"> 
								Check out our gameplay video and get a sneak peek at the thrilling battles and strategic gameplay that await you. 
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center">
                            ...
                            <p class="section-paragraph">Sign up to our newsletter to be the first to know when our game releases</p>
                        </div>
                        ...
                        <form method="post">
                            <div class="footer-form newsletter-form field field-grouped">
                                <div class="control control-expanded">
                                    <input class="input" type="email" name="email"  id="eml" placeholder="Your best email&hellip;">
                                </div>
                                <div class="control">
                                    <button class="button button-primary button-block button-shadow" type="submit" name="submit">Get Notified</button>
                                </div>
                            </div>
                        </form>
